...
public class pnlLapHoaDon11 extends javax.swing.JPanel {
	...
	String formattedDate2 = formatter.format(currentDate);
      ...
      //  kiemTraDuLieuFloat(txtTienKhachDua);
		...
		phimTatChoButton(btnDanhSachHangCho, "F5", () -> {
			danhSachHangCho();
		});
        //scan
    ...
    private int  soLuongToiDaDeThem(String maSanPham){
           ...
           String json = Gson.toJson(sanPham_DAO.layDanhSachTheoMaSach(maSanPham));
           
           JsonObject jsonObject  = Gson.fromJson(json, JsonObject.class);
         
              soLuongTon = jsonObject.get("soLuongTon").getAsInt();
    ...
    private void initComponents() {
        ...
        pnlTacVu2.add(btnLamMoi2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 160, -1));
        ...
        pnlTacVu2.add(btnThemVaoHangCho, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 30, -1, -1));

        btnDanhSachHangCho.setText("Xem hàng chờ (F5)");
        btnDanhSachHangCho.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDanhSachHangChoActionPerformed(evt);
            }
        });
        pnlTacVu2.add(btnDanhSachHangCho, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, 160, -1));
...
// In ra tổng tiền hoặc thực hiện các thao tác khác với giá trị này
    ...
    public boolean capNhatDanhSanPham_TheMa(String maSanPham){
    	
    	
    	 sanPham_DAO = new SanPhamDAO_IMP();
    	 if(sanPham_DAO.layDanhSachTheoMaSach(maSanPham) !=null) {
         String json = Gson.toJson(sanPham_DAO.layDanhSachTheoMaSach(maSanPham));
            ...
            System.out.println(soLuongTon);
                   ...
                   if(tinhTrang.equals("Ngừng kinh doanh") || soLuongTon==0){
                    ...
                    txtMaSanPham.setText( jsonObject.get("maSanPham").getAsString());
                   txtTenSanPham.setText(jsonObject.get("tenSanPham").getAsString());
                   txtGiaBan.setText(jsonObject.get("donGia").getAsDouble()+"");
    ...
    private void btnThanhToanHangDoiActionPerformed(java.awt.event.ActionEvent evt) { 
         ...
         if(row != -1) {
             ...
             if(tongTien() == 0.0 ){
				...
				JOptionPane.showMessageDialog(this, "Chọn khách hàng để thanh toán");
			}
